...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-font-lock" '("elm--" "elm-font-lock-multiline-list-delimiters-face" "elm-font-lock-operators-face" "turn-on-elm-font-lock")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-format" '("elm-format-on-save" "elm-format-command")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-indent" '("elm-indent-" "turn-off-elm-indent")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-mode" '("elm-mode-map" "elm-mode-after-save-handler")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-tags" '("elm-tags-regexps" "elm-tags-exclude-elm-stuff" "elm-tags-on-save")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elm-util" '("elm--" "elm-package-json" "elm-main-file")))
