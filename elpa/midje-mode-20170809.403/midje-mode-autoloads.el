...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "clojure-jump-to-file" '("clojure-midje-" "midje-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "midje-mode" '("last-checked-midje-fact" "midje-" "nrepl-check-fact-handler")))
